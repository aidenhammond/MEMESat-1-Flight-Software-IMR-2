...
namespace Ref {
  ...
  namespace {
    ...
    Drv::LinuxSerialDriverCompImpl uartDriver;
    uartDriver.init(1);

    if (uartDriver.open((char*) "/dev/tty", 
       ...
       uartDriver.startReadThread(94, 20*1024);
    }
    ...
    // uartDriver
    Drv::LinuxSerialDriverCompImpl uartDriver(FW_OPTIONAL_NAME("uartDriver"));
