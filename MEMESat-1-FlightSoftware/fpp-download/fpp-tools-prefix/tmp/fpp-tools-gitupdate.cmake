...
execute_process(
  COMMAND "/usr/bin/git" show-ref ee355fc99eb8040157c62e69f58ac6a8435cd981
  WORKING_DIRECTORY "/home/aiden/SSRL/MEMESat-1-FlightSoftware/fpp-tools/src"
...
if("${show_ref_output}" MATCHES "refs/remotes/ee355fc99eb8040157c62e69f58ac6a8435cd981")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "ee355fc99eb8040157c62e69f58ac6a8435cd981")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "ee355fc99eb8040157c62e69f58ac6a8435cd981")
endif()

# This will fail if the tag does not exist (it probably has not been fetched
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 ee355fc99eb8040157c62e69f58ac6a8435cd981
  WORKING_DIRECTORY "/home/aiden/SSRL/MEMESat-1-FlightSoftware/fpp-tools/src"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/fprime-community/fpp'")
  endif()
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/aiden/SSRL/MEMESat-1-FlightSoftware/fpp-tools/src/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/aiden/SSRL/MEMESat-1-FlightSoftware/fpp-tools/src/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
