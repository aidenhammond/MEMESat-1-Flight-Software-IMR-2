...
#ifndef SYSTEMRESOURCES_COMP_HPP_
#define SYSTEMRESOURCES_COMP_HPP_
...
namespace Svc {
  ...
  PROTECTED:
    ...
    enum {
      EVENTID_VERSION = 0x0, /* Version of the git repository. */
    };
  ...
  PROTECTED:
    ...
    enum {
      ...
      CHANNELID_VERSION = 0x15, //!< Channel ID for VERSION
    };
  ...
  PROTECTED:
    ...
    //! Write telemetry channel VERSION
    //!
    /* System's CPU Percentage */
    void tlmWrite_VERSION(
